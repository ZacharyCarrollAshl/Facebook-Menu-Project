...
public class Driver {
	...
	public static int showMenu() {
		...
		Print.println("13: Quit"); // This prints out the menu.
	...
	private static void UndoUserAction() {
		...
		if (!UndoStack.hasUndo()) { //If UndoStack doesn't have actions to undo...
			System.out.println("There is currently nothing that is undoable, try again! :P"); //Prints out this error message and returns.
			return;
		}
