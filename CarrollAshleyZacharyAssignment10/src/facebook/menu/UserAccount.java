...
public abstract class UserAccount implements Serializable {
	private static final long serialVersionUID = -5770263722636254995L; // This isn't needed but it was added so the
																		// class would stop saying it was needed.
	...
	public String toString() {
		return username; // I used the example from the
							// video
...
//I followed the 2nd part of the video talking about XBankAccount & XBankDriver to write this. I just right clicked and went to source and clicked
	...
	// This method is abstract because different types of user accounts may provide
	// different
