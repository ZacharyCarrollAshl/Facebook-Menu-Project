...
public class Facebook {
	...
	public ArrayList<FacebookUser> getUsersAlphabetically() {
		...
		Collections.sort(sortedUsers, new FacebookUserComparator()); //This sorts the Users list by the FacebookUserComparator.
	...
	public ArrayList<FacebookUser> getUsersByFriendCount() {
		...
		Collections.sort(sortedUsers, new FacebookFriendCountComparator()); //This sorts the Users list by the FacebookFriendCountComparator.
